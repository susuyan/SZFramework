...
@interface SZPhotoViewController () <SZPhotoViewDelegate>
...
@implementation SZPhotoViewController
...
- (void)showPhotoViewAtIndex:(int)index {
    ...
    if (!photoView) { // 添加新的图片view
        photoView = [[SZPhotoView alloc] initWithFrame:self.view.frame];
