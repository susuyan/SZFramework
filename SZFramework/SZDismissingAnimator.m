...
@implementation SZDismissingAnimator
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    offscreenAnimation.toValue = @(fromVC.view.layer.position.y + transitionContext.containerView.frame.size.height);
